...
def main():
    ...
    parser.add_argument('--OutputPath', help='Path to where the test bench should be created',default="TargetX/tests/TXWaveFormReadout")
    parser.add_argument('--EntityName', help='Name of the entity Test bench',default="txwaveformreadout")
